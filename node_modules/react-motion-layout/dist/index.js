...
var GlobalContext = React__default.createContext();

function useFirstEffect(fn, deps) {
  var firstEffect = React.useRef(true);
...
var ScreenContext = React__default.createContext();
/**
...
function MotionScreen(_ref) {
  var children = _ref.children,
      ...
      onExit = _ref.onExit;
  var nameRef = React.useRef(name || randomString());

  var _ref2 = React.useContext(GlobalContext) || {},
  ...
  return React__default.createElement(ScreenContext.Provider, {
    value: contextValue
  }, children);
}
...
function RenderTarget(_ref) {
  ...
  var animatedComponentsCount = React.useRef(0);
  var animated = React.useRef(false);
  var ref = React.useRef(null);

  var _useContext = React.useContext(ScreenContext),
      screenName = _useContext.screenName,
      onExit = _useContext.onExit,
      onEnter = _useContext.onEnter;

  var _useContext2 = React.useContext(GlobalContext),
  ...
  var getPoints = React.useCallback(function (sourceRect, targetRect) {
    return {
      source: {
  ...
  var onAnimationComplete = React.useCallback(function () {
  ...
  var tween = React.useCallback(function () {
    if (!onEnter) {
      cleanUp();
      return;
    }
    ...
    var AnimationComponents = Object.keys(sources).map(function (key) {
      ...
      return React__default.cloneElement(source.component, finalProps);
    });
...
var SceneContext = React__default.createContext();
/**
...
function MotionScene(props) {
  var _ref = React.useContext(GlobalContext) || {},
      store = _ref.store;
  ...
  var inTargetScene = React.useMemo(function () {
  ...
  return React__default.createElement(SceneContext.Provider, {
    value: contextValue
  }, inTargetScene ? React__default.createElement(RenderTarget, props) : React__default.createElement(RenderSource, props));
}
...
function BaseElement(_ref) {
  ...
  var _useContext = React.useContext(SceneContext),
  ...
  var _useContext2 = React.useContext(ScreenContext),
      screenName = _useContext2.screenName;

  var isRegistered = React.useMemo(function () {
  ...
  var attachRef = React.useCallback(function (ref) {
  ...
  return React__default.cloneElement(children, _objectSpread2({}, children.props, {
    ref: attachRef,
    easing: easing
  }));
}
...
var MotionImageForwardRef = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(Motion, _extends({}, props, {
    handleRef: ref
  }));
});
...
function Text(_ref) {
  ...
  return React__default.createElement(BaseElement, {
    animationKey: animationKey,
  ...
  }, React__default.createElement(MotionImageForwardRef, _extends({
    type: componentTypes.text
  }, props)));
}
Text.propTypes = {
...
function MotionProvider(_ref) {
  ...
  var log = React.useMemo(function () {
  ...
  var dispatch = React.useCallback(function (params) {
    log.info('->', params);
...
exports.MotionLayoutProvider = MotionProvider;
exports.MotionScene = MotionScene;
exports.MotionScreen = MotionScreen;
